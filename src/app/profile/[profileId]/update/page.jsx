...
export default async function UpdateProfilePage({ params }) {
  ...
  return (
    <section className="flex flex-col items-center justify-center">
      ...
      <h1 className=" text-2xl text-center md:text-5xl md:mb-4 lg:max-w-[40dvw] py-6 md:py-8">
        Update Your Profile
      </h1>
      ...
      >
        ...
        <input
          ...
          className="bg-white text-neutral-900 border border-neutral-400 rounded p-2 w-full"
        />
        ...
        <select
          name="platform"
          className="w-full bg-white text-neutral-900 rounded mb-4 p-2 border border-neutral-400"
