...
export const dbqry = {
  ...
  getGamesByUserCat:
    "SELECT * FROM users_games WHERE user_id=$1 AND category=$2",
  ...
  setStatus: "UPDATE users_games SET status=$1 WHERE game_id=$2 AND user_id=$3", // W/P/C/D, or null for unselected
  setReviewed:
